    ...
    <section className=' min-h-screen flex flex-col justify-start items-center p-5 text-center'>
     ...
     /></div>
       ...
       <div className=''>
        ...
        <a href="https://drive.google.com/file/d/1KaGZP5jm-MXbQzrl6wzUBQku79bGbRaC/view?usp=sharing" download={true} className='flex items-center justify-center mt-10 bg-gradient-to-r from-rose-600 to-teal-500 text-white py-2 rounded-lg'> Resume</a>
       </div>
