    ...
    <section className=' min-h-screen flex flex-col justify-start items-center p-5 text-center'>
     ...
     /></div>
       ...
       <div className=''>
        ...
        <a href="https://app.luminpdf.com/viewer/65a1f01b45f9b36e393b6f2b" download={true} className='flex items-center justify-center mt-10 bg-gradient-to-r from-rose-600 to-teal-500 text-white py-2 rounded-lg'> Resume</a>
       </div>
